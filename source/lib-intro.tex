...
names within the global namespace, while the \Java{} headers for C library
...
the behavior of a \Java{} program is undefined if it adds declarations or definitions to namespace
\tcode{std}
