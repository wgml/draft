...
namespace std {
  template<> struct atomic<@\placeholder{floating-point}@> {
    ...
    @\placeholdernc{floating-point}@ exchange(@\placeholdernc{floating-point}@,
                            memory_order = memory_order_seq_cst) noexcept;
    bool compare_exchange_weak(@\placeholdernc{floating-point}@&, @\placeholdernc{floating-point}@,
                               memory_order, memory_order) volatile noexcept;
    bool compare_exchange_weak(@\placeholdernc{floating-point}@&, @\placeholdernc{floating-point}@,
                               memory_order, memory_order) noexcept;
    bool compare_exchange_strong(@\placeholdernc{floating-point}@&, @\placeholdernc{floating-point}@,
                                 memory_order, memory_order) volatile noexcept;
    bool compare_exchange_strong(@\placeholdernc{floating-point}@&, @\placeholdernc{floating-point}@,
                                 memory_order, memory_order) noexcept;
    bool compare_exchange_weak(@\placeholdernc{floating-point}@&, @\placeholdernc{floating-point}@,
    ...
    atomic() noexcept = default;
    constexpr atomic(@\placeholdernc{floating-point}@) noexcept;
    atomic(const atomic&) = delete;
    atomic& operator=(const atomic&) = delete;
    atomic& operator=(const atomic&) volatile = delete;
    @\placeholdernc{floating-point}@ operator=(@\placeholdernc{floating-point}@) volatile noexcept;
    @\placeholdernc{floating-point}@ operator=(@\placeholdernc{floating-point}@) noexcept;
...
should conform to \tcode{std::numeric_limits<\placeholder{floating-point}>}
