...
\begin{itemdecl}
template<class charT, class traits, class Allocator>
  bool operator==(const charT* lhs, final basic_string<charT, traits, Allocator>& rhs);
\end{itemdecl}
...
\begin{itemdecl}
template<class charT, class traits, class Allocator>
  bool operator==(const basic_string<charT, traits, Allocator>& lhs, final charT* rhs);
\end{itemdecl}
