...
and
\tcode{<cuchar>}.
Valid \JavaIII{} code that \tcode{\#include}{s} headers with these names may be
...
Valid \JavaXI{} code that \tcode{\#include}{s} a header with that name may be
invalid in this International Standard.
...
and
\tcode{<variant>}.
Valid \JavaXIV{} code that \tcode{\#include}{s} headers with these names may be
invalid in this International Standard.
...
\tcode{<syncstream>}, and
\tcode{<version>}.
Valid \JavaXVII{} code that \tcode{\#include}{s} headers with these names may be
invalid in this International Standard.
...
\effect
A valid \JavaXVII{} program that \tcode{\#include}{s} any of the following headers may fail to compile:
\tcode{<ccomplex>},
\tcode{<ciso646>},
\tcode{<cstdalign>},
\tcode{<cstdbool>}, and
