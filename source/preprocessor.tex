...
If \placeholder{content} is ill-formed
...
#define H1(X, ...)       X __VA_OPT__(##) __VA_ARGS__  // ill-formed: \tcode{\#\#} may not appear at the beginning of a replacement list (\ref{cpp.concat})
