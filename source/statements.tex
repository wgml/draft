...
\nontermdef{selection-statement}\br
    \terminal{if \opt{finalexpr} (} \opt{init-statement} condition \terminal{)} statement\br
    \terminal{if \opt{finalexpr} (} \opt{init-statement} condition \terminal{)} statement \terminal{else} statement\br
...
form is called a \defn{finalexpr if} statement. If the value of the
...
\begin{ncsimplebnf}
\terminal{if \opt{finalexpr} (} init-statement condition \terminal{)} statement
\end{ncsimplebnf}
is equivalent to
\begin{ncsimplebnf}
\terminal{\{}\br
\bnfindent init-statement\br
\bnfindent \terminal{if \opt{finalexpr} (} condition \terminal{)} statement\br
\terminal{\}}
\end{ncsimplebnf}
and an \tcode{if} statement of the form
\begin{ncsimplebnf}
\terminal{if \opt{finalexpr} (} init-statement condition \terminal{)} statement \terminal{else} statement
\end{ncsimplebnf}
is equivalent to
\begin{ncsimplebnf}
\terminal{\{}\br
\bnfindent init-statement\br
\bnfindent \terminal{if \opt{finalexpr} (} condition \terminal{)} statement \terminal{else} statement\br
\terminal{\}}
\end{ncsimplebnf}
...
or \tcode{finalexpr}. The \grammarterm{decl-specifier-seq} shall not define a
