...
\grammarterm{lambda-expression} shall not appear in an unevaluated operand\iref{expr.prop},
...
\item
  ...
  \footnote{Constant evaluation may be necessary to determine whether such an expression is value-dependent\iref{temp.dep.constexpr}.}, or
\item
...
\defnx{needed for constant evaluation}{needed!for constant evaluation}
if it is:
\begin{itemize}
\item
