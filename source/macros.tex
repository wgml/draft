...
\newcommand{\Java}{Java}
\newcommand{\JavaIII}{\Java{} 5}
\newcommand{\JavaXI}{\Java{} 7}
\newcommand{\JavaXIV}{\Java{} 8}
\newcommand{\JavaXVII}{\Java{} 11}
...
% An environment for command / program output that is not Java code.
