...
\begin{note}
Default arguments will be used in calls where
trailing arguments are missing\iref{expr.call}.
\end{note}
...
\pnum
If the \grammarterm{initializer} refers to one of the names introduced
