...
Exceptions thrown in destructors of objects with thread storage duration or in constructors of package-scope objects with thread storage duration are not caught by a
\grammarterm{function-try-block}
